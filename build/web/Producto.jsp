  ...
  <path d="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5L14 4.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h-2z"/>
        ...
        <div class="d-flex">
                    ...
                    <div class="card-body">
                        <form action="ControladorProducto?menu=Producto" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="${producto.getNom()}" name="txtNombre" class="form-control" required="" placeholder="">
                            </div>
                            <div class="form-group">
                                <label>Precio</label>
                                <input type="number" value="${producto.getPre()}" name="txtPrecio" class="form-control" required="">
                            </div>
                            <div class="form-group">
                                <label>Medida</label>
                                <input type="text" value="${producto.getMed()}" name="txtMedida" class="form-control" required="">
                            </div>
                            <div class="form-group">
                                <label>Stock</label>
                            ...
                            <div class="form-group" required="">
                                ...
                                <input type="number" value="${producto.getIdcat()}" name="txtCategoria" class="form-control">
                            </div>
                            <div class="form-group" required="">
                                <label>ID Ubicacion</label>
                                <input style="appearance: black" type="number" value="${producto.getIdubi()}" name="txtUbicacion" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Tipo</label>
                                <select value="${producto.getTipo()}" name="txtTipo" class="form-control">
            ...
            <div class="col-sm-9">
                ...
                <div class="card">                    
                    <div class="card-body">
                        <label style="background: #B6E7D8; padding: 10px; border-radius: 15px;color:black;">
                            ...
                            <tbody>
                                <c:forEach var = "em" items = "${productos}"> 
                                    <tr>
                                        ...
                                        <td>${em.getTipo()}</td> 
                                        <td>
                                            <a type="submit" id="editar" class="btn btn-warning" href = "ControladorProducto?menu=Producto&accion=Editar&id=${em.getId()}" > 
                                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                    <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                                    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                                </svg> 
                                            </a> 
                                            <a id="eliminar" class="btn btn-danger" href = "ControladorProducto?menu=Producto&accion=Delete&id=${em.getId()}" > 
