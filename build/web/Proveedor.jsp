                ...
                <div class="card">
                    <div class="card-body">
                        <form action="ControladorProveedor?menu=Proveedor" method="POST">
                            ...
                            <div class="form-group">
                                <label>Correo</label>
                                <input type="email" value="${proveedor.getMail()}" name="txtCorreo" required="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Nombre</label>
                                <input type="text" value="${proveedor.getNom()}" name="txtNombres" required="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>RUC</label>
                                <input type="number" value="${proveedor.getRuc()}" name="txtRuc" required="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Telefono</label>
                                <input type="number" value="${proveedor.getTel()}" name="txtTelefono" required="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Direccion</label>
                                <input type="text" value="${proveedor.getDir()}" name="txtDireccion" required="" class="form-control">
                            </div>
                            
                            <div class="form-group">
                                <label>Estado</label>
                                <select value="${proveedor.getEs()}" name="txtEstado" class="form-control">
                            ...
                            <tbody> 
                                <c:forEach var="em" items="${proveedores}">
                                    <tr>
                                        ...
                                        <td>${em.getEs()}</td>                                      
                                        <td>
                                            <a type="submit" class="btn btn-warning" href="ControladorProveedor?menu=Proveedor&accion=Editar&id=${em.getId()}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                    <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                                    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                                </svg> 
                                            </a>
                                            <a class="btn btn-danger" href="ControladorProveedor?menu=Proveedor&accion=Delete&id=${em.getId()}">
